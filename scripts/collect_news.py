...
【期待するJSON】\n{{\n  "title": "見出し",\n  "content": "詳しい要約本文（内容の解説）",\n  "isBreaking": false\n}}\n【ニュース情報】\n{raw_news}"""
    ...
    try:
        ...
        if e.code == 404:
            print("💡ヒント: 「404 Not Found」エラーです。ご指定のモデル（gemini-3.6-flash）がAPI上に存在しないことが原因です。gemini-1.5-flash 等に変更してお試しください。")
        elif e.code == 400:
            print("💡ヒント: 「400 Bad Request」エラーです。APIキーが無効か、送信データに問題があります。")
        sys.exit(1)
    except Exception as e:
